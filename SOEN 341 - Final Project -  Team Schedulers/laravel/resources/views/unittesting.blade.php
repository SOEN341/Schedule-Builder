...
<script type="text/jsx">
	...
	//EDIT USERNAME
	response = serverBridge.editUsername('BatmanVsSuperman', 'password', function(data){
		if(data.success == "true"){
			console.log("Username is successfully edited");
		}
		else{
			console.log("Username was not successfully edited");
		}
	});
	...
	//GET COURSES
	response = serverBridge.getCourses(function(data){
		if(data.success == "true"){
			console.log("Courses was retrieved");
		}
		else{
			console.log("Courses was not retrieved");
		}
	});

	//GET TAKEN COURSES
	response = serverBridge.getTakenCourses(function(data){
		if(data.success == "true"){
			console.log("Taken courses was retrieved");
		}
		else{
			console.log("Taken courses was not retrieved");
		}
	});

	//GET NEEDED COURSES
	reponse = serverBridge.getNeededCourses(function(data){
		if(data.success == "true"){
			console.log("Needed courses was retrieved");
		}
		else{
			console.log("Needed courses was not retrieved");
		}
	});
	cookieManager.removeCookie("username");

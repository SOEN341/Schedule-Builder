...
('WWWI',1,'H-917','Winter','Lab',3,'16:15:00','18:05:00',83,'COMP 371', 1);
('WWWJ',2,'H-917','Winter','Lab',4,'20:30:00','22:20:00',83,'COMP 371', 1);
('WWWK',3,'H-811','Winter','Lab',4,'15:45:00','17:35:00',83,'COMP 371', 1);
('WW',4,'H-507','Winter','Lecture',4,'17:45:00','20:15:00',83,'COMP 371', 1);

('NNNI',5,'H-917','Winter','Lab',1,'20:25:00','22:25:00',86,'COMP 472', 1);
('NNNJ',6,'H-917','Winter','Lab',4,'17:45:00','19:45:00',86,'COMP 472', 1);
('NNNK',7,'H-849','Winter','Lab',1,'20:25:00','22:25:00',86,'COMP 472', 1);
('NN',8,'H-561','Winter','Lecture',1,'17:45:00','20:15:00',86,'COMP 472', 1);

('N NI',9,'H-849','Winter','Lab',2,'18:10:00','20:00:00',87,'COMP 476', 1);
('N NJ',10,'H-849','Winter','Lab',3,'18:10:00','20:00:00',87,'COMP 476', 1);
('N NK',11,'H-849','Winter','Lab',4,'18:10:00','20:00:00',87,'COMP 476', 1);
('N',12,'H-411','Winter','Lecture',24,'14:45:00','16:00:00',87,'COMP 476', 1);

('XI-X',13,'H-929','Winter','Lab',3,'17:15:00','19:05:00',91,'COMP 353', 1);
('XJ-X',14,'H-905','Winter','Lab',1,'17:15:00','19:05:00',91,'COMP 353', 1);
('XK-X',15,'H-967','Winter','Lab',3,'17:15:00','19:05:00',91,'COMP 353', 1);
('X XA',16,'H-443','Winter','Tutorial',3,'16:15:00','17:05:00',91,'COMP 353', 1);
('X XB',17,'H-605','Winter','Tutorial',3,'16:15:00','17:05:00',91,'COMP 353', 1);
('X',18,'FC-C070','Winter','Lecture',13,'13:15:00','14:30:00',91,'COMP 353', 1);

('W WI',19,'H-831','Winter','Lab',1,'11:10:00','13:00:00',93,'COMP 445', 1);
('W WJ',20,'H-917','Winter','Lab',3,'11:10:00','13:00:00',93,'COMP 445', 1);
('W',21,'H-521','Winter','Lecture',13,'13:15:00','14:30:00',93,'COMP 445', 1);

('NI-X',22,'H-967','Winter','Lab',3,'20:30:00','22:20:00',96,'SOEN 487', 1);
('NJ-X',23,'H-917','Winter','Lab',3,'20:30:00','22:20:00',96,'SOEN 487', 1);
('NNNA',24,'H-831','Winter','Tutorial',3,'16:15:00','17:05:00',96,'SOEN 487', 1);
('NNNB',25,'H-843','Winter','Tutorial',3,'16:15:00','17:05:00',96,'SOEN 487', 1);
('N',26,'FC-B055','Winter','Lecture',3,'17:45:00','20:15:00',96,'SOEN 487', 1);

('UUUI',27,'H-847','Winter','Lab',2,'15:00:00','17:00:00',106,'COMP 474', 1);
('UUUJ',28,'H-847','Winter','Lab',2,'18:00:00','20:00:00',106,'COMP 474', 1);
('UU',29,'H-537','Winter','Lecture',3,'17:45:00','20:15:00',106,'COMP 474', 1);

('W',30,'ONLINE','Winter','Lecture',0,'00:00:00','00:00:00',110,'ENGR 411', 1);

('EC',31,'ONLINE','Winter','Lecture',0,'00:00:00','00:00:00',113,'ECON 201', 1);
('G',32,'MB-1210','Winter','Lecture',13,'16:15:00','17:30:00',113,'ECON 201', 2);
('H',33,'MB-1210','Winter','Lecture',13,'11:45:00','13:00:00',113,'ECON 201', 3);
('I',34,'MB-1210','Winter','Lecture',13,'08:45:00','10:00:00',113,'ECON 201', 4);

('SSSA',35,'EV-1162','Winter','Tutorial',4,'17:45:00','18:35:00',55,'ENGR 301', 2);
('SSSB',36,'EV-3309','Winter','Tutorial',4,'17:45:00','18:35:00',55,'ENGR 301', 2);
('SSSC',37,'EV-1162','Winter','Tutorial',2,'18:45:00','19:35:00',55,'ENGR 301', 2);
('SSSD',38,'EV-1162','Winter','Tutorial',2,'18:45:00','19:35:00',55,'ENGR 301', 2);
('SS',39,'H-533','Winter','Lecture',1,'17:45:00','20:15:00',55,'ENGR 301', 2);
('R RA',40,'EV-1162','Winter','Tutorial',2,'17:45:00','18:35:00',55,'ENGR 301', 1);
('R RB',41,'EV-3309','Winter','Tutorial',2,'17:45:00','18:35:00',55,'ENGR 301', 1);
('R RC',42,'EV-1162','Winter','Tutorial',4,'18:45:00','19:35:00',55,'ENGR 301', 1);
('R RD',43,'EV-3309','Winter','Tutorial',4,'18:45:00','19:35:00',55,'ENGR 301', 1);
('R',44,'H-533','Winter','Lecture',24,'16:15:00','17:30:00',55,'ENGR 301', 1);

('UUUA',45,'H-929','Winter','Tutorial',4,'20:30:00','21:20:00',52,'ENGR 391', 1);
('UUUB',46,'H-967','Winter','Tutorial',4,'20:30:00','21:20:00',52,'ENGR 391', 1);
('UU',47,'H-531','Winter','Lecture',4,'17:45:00','20:15:00',52,'ENGR 391', 1);
('X XA',48,'H-929','Winter','Tutorial',4,'13:15:00','14:05:00',52,'ENGR 391', 3);
('X XB',49,'H-929','Winter','Tutorial',4,'15:15:00','16:05:00',52,'ENGR 391', 3);
('X',50,'H-535','Winter','Lecture',35,'08:45:00','10:00:00',52,'ENGR 391', 3);
('V VA',51,'H-629','Winter','Tutorial',5,'11:45:00','12:35:00',52,'ENGR 391', 2);
('V VB',52,'H-629','Winter','Tutorial',5,'13:15:00','14:05:00',52,'ENGR 391', 2);
('V',53,'H-415','Winter','Lecture',24,'13:15:00','14:05:00',52,'ENGR 391', 2);

('P',54,'H-407','Winter','Lecture',5,'08:45:00','11:30:00',58,'ENGR 392', 1);
('Q',55,'H-420','Winter','Lecture',13,'16:15:00','17:30:00',58,'ENGR 392', 2);
('RR',56,'FG-B030','Winter','Lecture',2,'17:45:00','20:15:00',58,'ENGR 392', 3);

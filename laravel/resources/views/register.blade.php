...
$response= mysqli_query($dbc,$query);
 ...
 if(mysqli_num_rows($response) <= 0){
    //$sql = "INSERT INTO `341db`.`users` (`username`, `email`, `userType`, `password`, `CoursesDones`, `CoursesRem`, `CLoad`, `dayOff`, `pTime`) VALUES ('$username', '$email', '0', '$password', 'cdone', 'crem', '4', 'Monday', 'Afternoons');";
     ...
     $sql = "INSERT INTO users (username, email, userType, password, CoursesDones, CoursesRem, CLoad, dayOff, pTime) VALUES ('$username', '$email', FALSE ,'$encryptedPassword', 'cdone', 'crem', '4', 'Monday', 'Afternoons')";
